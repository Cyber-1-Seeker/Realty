    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_area', models.DecimalField(decimal_places=2, max_digits=8, validators=[django.core.validators.MinValueValidator(1)], verbose_name='Общая площадь (м²)')),
                ...
                ('rooms', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(0)], verbose_name='Количество комнат')),
                ...
                ('price', models.BigIntegerField(validators=[django.core.validators.MinValueValidator(1)], verbose_name='Цена')),
                ...
                ('deposit', models.BigIntegerField(blank=True, null=True, verbose_name='Залог (для аренды)')),
